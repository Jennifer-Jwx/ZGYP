...
export default class GongMeiKongJian extends Component {
  constructor() {
    super();
  }

  componentDidMount() {
  	eventProxy.trigger('msg', [{liclasses: '', ahref: '#!/default', text: '首页'}, {liclasses: '', ahref: '', text: '术 • 百科'}, , {liclasses: '', ahref: '', text: '工美空间'}]);
  }
