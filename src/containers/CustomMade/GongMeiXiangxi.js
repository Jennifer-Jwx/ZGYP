...
export default class GongMeiXiangXi extends Component {
  constructor() {
    super();
    this.state = {
    }
  ...
  componentDidMount() {
  	eventProxy.trigger('msg', [{liclasses: '', ahref: '#!/default', text: '首页'}, {liclasses: '', ahref: '#!/sbk_first', text: '术 • 百科'}, {liclasses: '', ahref: 'sbk_gmkj_hw_two', text: '工美空间'}, {liclasses: '', ahref: '', text: '详细'}]);
  }
    ...
    return(
		<article className={styles.service}>
		    ...
		    <div className={styles.fl_box}>
		        <img className={styles.dzd} src="http://www.goto720.com/ypapp/img/sbk_gmkj_xx_bg1.png" alt=""/>
		    </div>
		    <img className={styles.imgfl} src="http://www.goto720.com/ypapp/photo/sbk20.jpg" alt=""/>
