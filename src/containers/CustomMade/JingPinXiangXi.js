...
export default class JingPinXiangXi extends Component {
  constructor() {
    super();
    this.state = {
    }
  ...
  componentDidMount() {
  	eventProxy.trigger('msg', [{liclasses: '', ahref: '#!/default', text: '首页'}, {liclasses: '', ahref: '#!/sbk_first', text: '术 • 百科'}, {liclasses: '', ahref: 'wr_sbk_hytt', text: '工美空间'}, {liclasses: '', ahref: '', text: '详细'}]);
  }
  ...
  render() {
    ...
    return(
		<article className={styles.service}>
		    ...
		    <img className={styles.imgfl} src="http://www.goto720.com/ypapp/photo/sbk21.jpg" alt=""/>
    		<img className={styles.imgfl + ' ' + styles.mt} src="http://www.goto720.com/ypapp/photo/sbk22.jpg" alt=""/>
